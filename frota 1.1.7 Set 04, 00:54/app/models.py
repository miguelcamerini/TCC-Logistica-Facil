...
class Viagem(models.Model):
    ...
    def clean(self):
        ...
        # Validação de datas e valores de adiantamento/quitação
    ...
    def __str__(self):
        v_nome = f" ({self.veiculo_1.placa})" if self.veiculo_1 else ""
        return f"{self.local_inicio} ➔ {self.local_final}{v_nome}"
