...
urlpatterns = [
    ...
    # ROTAS DE ABASTECIDA
    path('lista_abastecida/', views.lista_abastecida, name='lista_abastecida'),
    path('abastecida/adicionar-viagem/', views.add_abastecida_viagem, name='add_abastecida_viagem'),
    path('abastecida/adicionar-comum/', views.add_abastecida, name='add_abastecida'),
    path('abastecida/editar/<int:pk>/', views.edit_abastecida, name='edit_abastecida'),
    path('abastecida/excluir/<int:pk>/', views.excluir_abastecida, name='excluir_abastecida'),
    
    path('perfil/excluir-conta/', views.excluir_conta_user, name='excluir_conta_user'),
]
