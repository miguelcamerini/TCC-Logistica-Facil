...
class ViagemAdmin(admin.ModelAdmin):
    ...
    # Faz com que os selects de motorista e veículo abram uma janelinha de busca rápida 
    # ao invés de carregar um menu dropdown gigante que trava a página
    raw_id_fields = ('motorista', 'veiculo_1', 'reboque')
    
    # Adiciona a lista de Abastecidas desta viagem direto na tela de edição dela!
