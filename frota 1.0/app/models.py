...
class Veiculo(models.Model):
    ...
    placa = models.CharField(max_length=7, unique=True, verbose_name="Placa", db_index=True)
...
class Viagem(models.Model):
    ...
    valor_proposto = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Valor Proposto")
