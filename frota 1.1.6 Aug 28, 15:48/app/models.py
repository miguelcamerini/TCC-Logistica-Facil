...
class Caixa(models.Model):
    ...
    # Altera para SET_NULL para conseguirmos tratar a exclusão do caixa na viagem
    viagem = models.ForeignKey('Viagem', on_delete=models.SET_NULL, blank=True, null=True, verbose_name="Viagem Origem")
    ...
    def clean(self):
        v_saida = self.valor_saida or Decimal('0.00')
        v_entrada = self.valor_entrada or Decimal('0.00')
